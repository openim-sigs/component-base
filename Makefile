# Copyright 2023 OpenIM-Sigs. All rights reserved.
...
ROOT_PACKAGE=github.com/openim-sigs/compone-base
...
IMG ?= ghcr.io/openim-sigs/compone-base:latest
...
LICENSE_TEMPLATE ?= $(ROOT_DIR)/scripts/template/boilerplate.txt	# MIT License
...
EXCLUDE_TESTS=github.com/OpenIM-Sigs/CloudBuildAI/test
...
.PHONY: all
all: copyright-verify # tidy lint cover
...
copyright-add: tools.verify.addlicense
	...
	@$(TOOLS_DIR)/addlicense -y $(shell date +"%Y") -v -c "OpenIM-Sigs open source community." -f $(LICENSE_TEMPLATE) $(CODE_DIRS)
...
# example: ./coscli  cp/sync -r /root/workspaces/openim-sigs/compone-base/ cos://OpenIM-Sigs-1306374445/code/ -e cos.ap-hongkong.myqcloud.com
...
.PHONY: install.cfssl
install.cfssl:
	@$(ROOT_DIR)/script/install/install.sh OpenIM-Sigs::install::install_cfssl
